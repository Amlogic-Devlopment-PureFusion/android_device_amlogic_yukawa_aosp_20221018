...
# BOARD_SYSTEMIMAGE_PARTITION_RESERVED_SIZE := 377487360 # 360 MiB
BOARD_SYSTEMIMAGE_PARTITION_RESERVED_SIZE := 443547648 # 423 MiB
# 419430400 471859200 450887680 429916160 440401920 442499072 443547648
# 444596224
endif
# BOARD_SYSTEM_EXTIMAGE_PARTITION_RESERVED_SIZE := 30720000
# BOARD_VENDORIMAGE_PARTITION_RESERVED_SIZE := 30720000 # 29.2969 MiB
...
ifeq ($(TARGET_USE_AB_SLOT), true)
BOARD_SUPER_PARTITION_SIZE := 4831838208 # 4,608 MiB
else
BOARD_SUPER_PARTITION_SIZE := 5041553408 # 4.8 GiB
endif
# BOARD_DB_DYNAMIC_PARTITIONS_SIZE := 2415919104  # Reserve 4M for DAP metadata
BOARD_DB_DYNAMIC_PARTITIONS_SIZE := 4294967296  # Reserve 4M for DAP metadata
BOARD_SUPER_PARTITION_METADATA_DEVICE := super
BOARD_SUPER_IMAGE_IN_UPDATE_PACKAGE := true
# 2415919104 3221225472 1610612736 4294967296
